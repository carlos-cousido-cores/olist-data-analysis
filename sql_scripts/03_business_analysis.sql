...
15: Calculate customer retention rate according to geolocations
===============================================================================
*/
...
LEFT JOIN olist_products_dataset_clean p ON oi.product_id = p.product_id
...
FROM olist_order_items_dataset oi
LEFT JOIN olist_orders_dataset o ON o.order_id = oi.order_id
WHERE o.order_status != 'canceled' AND 
      o.order_delivered_customer_date IS NOT NULL;
...
FROM olist_order_items_dataset oi
LEFT JOIN olist_orders_dataset o ON o.order_id = oi.order_id
LEFT JOIN olist_products_dataset_clean p ON p.product_id = oi.product_id
CROSS JOIN (SELECT 
...
LEFT JOIN olist_order_items_dataset oi ON oi.order_id = op.order_id
LEFT JOIN olist_orders_dataset o ON o.order_id = op.order_id
LEFT JOIN olist_products_dataset_clean pr ON pr.product_id = oi.product_id
CROSS JOIN (SELECT 
...
INNER JOIN olist_order_reviews_dataset_clean r ON r.order_id = oi.order_id 
WHERE o.order_status != 'canceled' AND 
      o.order_delivered_customer_date IS NOT NULL and
...
WITH order_review_scores as (
	SELECT 
	   ...
	   AVG(review_score) AS review_score
	FROM olist_orders_dataset o
	INNER JOIN olist_order_reviews_dataset_clean r ON r.order_id = o.order_id
	WHERE o.order_status != 'canceled' AND 
		  o.order_delivered_customer_date IS NOT NULL
...
FROM olist_orders_dataset o
INNER JOIN olist_order_reviews_dataset_clean r ON o.order_id = r.order_id
WHERE order_status != 'canceled' AND 
...
LEFT JOIN olist_order_reviews_dataset_clean r ON r.order_id = o.order_id
LEFT JOIN olist_products_dataset_clean pr ON pr.product_id = oi.product_id
WHERE o.order_status != 'canceled' AND 
      o.order_delivered_customer_date IS NOT NULL AND 
...
FROM (
	...
	FROM olist_order_reviews_dataset_clean r
...
INNER JOIN olist_orders_dataset o ON o.order_id = op.order_id
WHERE o.order_status != 'canceled' AND 
